...
//Building global var
  var devIDlist = [];
  var devIDweb = "<?php echo $_GET['devid']; ?>";
</script>
...
<html>
	<head>
		...
		<script src="assets/js/deviceinfo.js?v=134"></script>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo">Iris Web Portal <strong><div id="portalVer"></div></strong></a>
