...
var HTMLfav = "";
var HTMLfavtable = "";
var TotalDimmersOn = 0;
var TotalDimmersOff = 0;
var TotalLightsOn = 0;
var TotalLightsOff = 0;
var TotalSwitchesOn = 0;
var TotalSwitchesOff = 0;
...
for (var i = 0; i < Devices.length; i++) {
		...
		document.getElementById("switches").innerHTML = HTMLfavtable + "</tbody></table>";
		document.getElementById("total").innerHTML = "Switches on " + TotalSwitchesOn + "; Dimmers on  " + TotalDimmersOn + "; Lights on  " + TotalLightsOn + "<br>Switches off " + TotalSwitchesOff + "; Dimmers off  " + TotalDimmersOff + "; Lights off  " + TotalLightsOff;
...
if (device.search("Switch") != -1){
		...
		devIDlist.push(ID);
		 ...
		 TotalSwitchesOn = TotalSwitchesOn + 1;
		 ...
		 TotalSwitchesOff = TotalSwitchesOff + 1;
		...
		devIDlist.push(ID);
		 if(state.search("ON") != -1){
			TotalDimmersOn = TotalDimmersOn + 1;
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px;color:green"></i></div></td>'
		 ...
		 if(state.search("OFF") != -1){
		 TotalDimmersOff = TotalDimmersOff + 1;
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px"></i></div></td>'
		...
		devIDlist.push(ID);
		 ...
		 if(state.search("OFF") != -1){
		 TotalLightsOff = TotalLightsOff + 1;
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><span id="DIMMER' + ID + '"><i onclick="turnondimmer(' + devIDlist.length + ')" class="fa fa-toggle-on" style="font-size:24px"></i></span> <input id="DIM' + ID + '" type="range" min="0" value="' + brightness + '" max="100" data-show-value="true" onchange="turnondimmer(' + devIDlist.length + ')"></td></tr>';
		 }
		//HTML = HTML + '<input id="ON' + ID + '" type="button" value="Turn on switch" onclick="turnonlight(' + devIDlist.length + ');">';
