...
function listDevices(devices){
	...
	if(HTMLfavtable == '<table class="tablesorter"><thead><tr><th><i class="fa fa-sort"></i>Name</th><th>Info</th><th>State</th><th>Control(s)</th></tr></thead>')
	{
		HTMLfav = HTMLfav + '<td>accessdenied broke your favorites...</td> <td> No you just need to add some.</td> <td></td> <td></td></tr>'
		HTMLfavtable = HTMLfavtable + HTMLfav;
	}
	document.getElementById("favtbody").innerHTML = HTMLfavtable + "</tbody></table>";
								...
								if (device.search("Light") == -1){
									if (device.search("Dimmer") == -1){
										if (device.search("Halo") == -1){
											if(fav == "true"){
												// document.getElementById("favDevices").innerHTML = document.getElementById("favDevices").innerHTML + HTML;
												HTMLfav = HTMLfav + '<td></td> <td></td> </tr>'
												HTMLfavtable = HTMLfavtable + HTMLfav;
	...
	if (device.search("Switch") != -1){
		...
		devIDlist.push(ID);
		 if(state.search("ON") != -1){
			 ...
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px;color:green"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><div id="SWITCH' + ID + '" ><i onclick="turnofflight(' + devIDlist.length + ')" class="fa fa-toggle-off" style="font-size:24px"></i></div></td></tr>';
		 }		 
		 if(state.search("OFF") != -1){
			 ...
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><div id="SWITCH' + ID + '"><i onclick="turnonlight(' + devIDlist.length + ')" class="fa fa-toggle-on" style="font-size:24px"></i></div></td></tr>';
		 }
		...
		devIDlist.push(ID);
		 if(state.search("ON") != -1){
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px;color:green"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><div id="DIMMER' + ID + '" ><i onclick="turnoffdimmer(' + devIDlist.length + ')" class="fa fa-toggle-off" style="font-size:24px"></i></div><br><input id="DIM' + ID + '" type="range" min="0" value="' + brightness + '" max="100" data-show-value="true" onchange="turnondimmer(' + devIDlist.length + ')"></td></tr>';
		 }		 
		 if(state.search("OFF") != -1){
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><div id="DIMMER' + ID + '"><i onclick="turnondimmer(' + devIDlist.length + ')" class="fa fa-toggle-on" style="font-size:24px"></i></div><BR><input id="DIM' + ID + '" type="range" min="0" value="' + brightness + '" max="100" data-show-value="true" onchange="turnondimmer(' + devIDlist.length + ')"></td></tr>';
		 }
		//HTML = HTML + '<input id="ON' + ID + '" type="button" value="Turn on switch" onclick="turnonlight(' + devIDlist.length + ');">';
		//HTML = HTML + '<input id="OFF' + devIDlist.length + '" type="button" value="Turn off switch" onclick="turnofflight(' + devIDlist.length + ');"> <br>';
		// document.getElementById("deviceSwitch").innerHTML = document.getElementById("deviceSwitch").innerHTML + HTML + "<P>";
		...
		devIDlist.push(ID);
		 if(state.search("ON") != -1){
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px;color:green"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><span id="DIMMER' + ID + '" ><i onclick="turnoffdimmer(' + devIDlist.length + ')" class="fa fa-toggle-off" style="font-size:24px"></i></span> <input id="DIM' + ID + '" type="range" min="0" value="' + brightness + '" max="100" data-show-value="true" onchange="turnondimmer(' + devIDlist.length + ')"></td></tr>';
		 }		 
		 if(state.search("OFF") != -1){
			 HTMLfav = HTMLfav + '<td><div id="STATE' + ID + '"><i class="fa fa-power-off" style="font-size:24px"></i></div></td>'
			 HTMLfav = HTMLfav + '<td><span id="DIMMER' + ID + '"><i onclick="turnondimmer(' + devIDlist.length + ')" class="fa fa-toggle-on" style="font-size:24px"></i></span> <input id="DIM' + ID + '" type="range" min="0" value="' + brightness + '" max="100" data-show-value="true" onchange="turnondimmer(' + devIDlist.length + ')"></td></tr>';
		 }
		//HTML = HTML + '<input id="ON' + ID + '" type="button" value="Turn on switch" onclick="turnonlight(' + devIDlist.length + ');">';
		//HTML = HTML + '<input id="OFF' + devIDlist.length + '" type="button" value="Turn off switch" onclick="turnofflight(' + devIDlist.length + ');"> <br>';
		// document.getElementById("deviceSwitch").innerHTML = document.getElementById("deviceSwitch").innerHTML + HTML + "<P>";
